...
function(){a.ptags_tags=b.map(a.ptags_tag_container.find("a.ui-ptags-tag-text"),function(a){return b(a).text()});a.ptags_update_val()}).bind("sortstop",function(){a.ptags_noclick=true});a.ptags_show_box||a.css("display","none");this.pines_tags=a});return this};b.fn.ptags.defaults={ptags_tags:[],ptags_current_text:true,ptags_delimiter:",",ptags_show_tags:true,ptags_show_box:false,ptags_input_box:true,ptags_remover:true,ptags_editable:true,ptags_sortable:false}})(jQuery);
